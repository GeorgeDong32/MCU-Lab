...
TAB1:   DB 0EEH, 0E7H, 0D7H, 0B7H, 0EBH, 0DBH, 0BBH, 0EDH ; 此表格对应按键的行列值
        DB 0DDH, 0BDH, 77H, 7BH, 7EH, 7DH, 0DEH, 0BEH

TAB2:   DB 0C0H, 0F9H, 0A4H, 0B0H, 99H, 92H, 82H, 0F8H ; 此表格对应按键显示的数字/字母
        DB 80H, 90H, 88H, 83H, 0C6H, 0A1H, 86H, 8EH, 0FFH ; "0"-"9"，"A"-"F"和不显示
    END